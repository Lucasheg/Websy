...
export default function App() {
  // ===== Maker state (lean but covers brand, layout, content essentials) =====
  ...
  const [layout, setLayout] = useState({
    animationLevel: "medium", // low | medium | high
    heroStyle: "editorial", // editorial | image | product
    showPricing: true,
  });
  ...
  // ===== Helpers for actions (keep App decoupled) =====
  ...
  // Single delegated click handler for everything inside Preview
  ...
  // ===== Derived preview config (what PreviewShell needs) =====
  const previewConfig = useMemo(() => {
    ...
    return {
      ...
      layout: {
        ...
        showPricing: layout.showPricing,
      },
      content: {
        goal: content.goal,
  ...
  return (
    <div className="page">
      {/* Global style tokens for Maker + Preview */}
      <style>{GLOBAL_CSS}</style>

      {/* ===== MAKER (full viewport on load) ===== */}
              ...
              <div className="grid2">
                ...
                <label>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setBrand((b) => ({ ...b, locations: e.target.value }))
                    }
                  />
                </label>
                <label>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setBrand((b) => ({ ...b, industry: e.target.value }))
                    }
                  >
                ...
                <label>
                  ...
                  <input
                    ...
                    value={brand.accent}
                    onChange={(e) =>
                      setBrand((b) => ({ ...b, accent: e.target.value }))
                    }
                  />
                </label>
                <label>
                  ...
                  <input
                    ...
                    value={brand.neutral}
                    onChange={(e) =>
                      setBrand((b) => ({ ...b, neutral: e.target.value }))
                    }
                  />
                </label>
                <label className="span2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setBrand((b) => ({ ...b, heroImage: e.target.value }))
                    }
                  />
                </label>
              </div>
              ...
              <div className="grid2">
                <label>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setLayout((l) => ({ ...l, heroStyle: e.target.value }))
                    }
                  >
                ...
                <label className="span2 chk">
                  <input
                    type="checkbox"
                    checked={layout.showPricing}
                    onChange={(e) =>
                      setLayout((l) => ({ ...l, showPricing: e.target.checked }))
                    }
                  />
                  <span>Show pricing section</span>
                </label>
              </div>
            </div>
          </details>
              ...
              <div className="grid2">
                <label>
                  ...
                  <select
                    value={content.goal}
                    onChange={(e) =>
                      setContent((c) => ({ ...c, goal: e.target.value }))
                    }
                  >
                ...
                <label className="span2">
                  <span className="lbl">
                    Testimonials (format: “Quote” — Name)
                  </span>
                  <textarea
                    rows={3}
                ...
                <label>
                  ...
                  <input
                    value={content.logos}
                    onChange={(e) =>
                      setContent((c) => ({ ...c, logos: e.target.value }))
                    }
                  />
                </label>
                ...
                <label>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setContent((c) => ({ ...c, metrics: e.target.value }))
                    }
                  />
                </label>
              </div>
...
/* ---------- Global CSS tokens + Maker layout (kept inline for simplicity) ---------- */
const GLOBAL_CSS = `
:root{
  --ink:#0f172a;
  --muted:#475569;
